...
ALIGN static const complex_t mdct_tab_1920[] = {
    ...
    {FRAC_CONST(0.000303650824695), FRAC_CONST(0.032273432771295)}, {FRAC_CONST(0.000198034825504), FRAC_CONST(0.032274253653254)}, {FRAC_CONST(0.000092416705518), FRAC_CONST(0.032274728903884)}};
        #ifdef LD_DEC
/* 240 (N/4) complex twiddle factors */
ALIGN const complex_t mdct_tab_960[] = {
...
#endif     // FIXED_POINT
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
ALIGN const real_t kbd_long_1024[] = {
...
#endif
ALIGN const real_t kbd_short_128[] = {
...
#ifdef ALLOW_SMALL_FRAMELENGTH
ALIGN const real_t kbd_short_120[] = {
...
ALIGN static const real_t ld_mid_512[] = {FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
    ...
    #ifdef ALLOW_SMALL_FRAMELENGTH
ALIGN static const real_t ld_mid_480[] = {FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
                                          FRAC_CONST(0),
