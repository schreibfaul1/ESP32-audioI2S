...
void Audio::showID3Tag(const char* tag, const char* value) {
    ps_ptr<char> id3tag;
    // V2.2
    if (!strcmp(tag, "CNT")) id3tag.appendf("Play counter: {}", value);
    if (!strcmp(tag, "COM")) id3tag.appendf("Comments: {}", value);
    if (!strcmp(tag, "CRA")) id3tag.appendf("Audio encryption: {}", value);
    if (!strcmp(tag, "CRM")) id3tag.appendf("Encrypted meta frame: {}", value);
    if (!strcmp(tag, "ETC")) id3tag.appendf("Event timing codes: {}", value);
    if (!strcmp(tag, "EQU")) id3tag.appendf("Equalization: {}", value);
    if (!strcmp(tag, "IPL")) id3tag.appendf("Involved people list: {}", value);
    if (!strcmp(tag, "PIC")) id3tag.appendf("Attached picture: {}", value);
    if (!strcmp(tag, "SLT")) id3tag.appendf("Synchronized lyric/text: {}", value);
    if (!strcmp(tag, "TAL")) id3tag.appendf("Album/Movie/Show title: {}", value);
    if (!strcmp(tag, "TBP")) id3tag.appendf("BPM (Beats Per Minute): {}", value);
    if (!strcmp(tag, "TCM")) id3tag.appendf("Composer: {}", value);
    if (!strcmp(tag, "TCO")) id3tag.appendf("Content type: {}", value);
    if (!strcmp(tag, "TCR")) id3tag.appendf("Copyright message: {}", value);
    if (!strcmp(tag, "TDA")) id3tag.appendf("Date: {}", value);
    if (!strcmp(tag, "TDY")) id3tag.appendf("Playlist delay: {}", value);
    if (!strcmp(tag, "TEN")) id3tag.appendf("Encoded by: {}", value);
    if (!strcmp(tag, "TFT")) id3tag.appendf("File type: {}", value);
    if (!strcmp(tag, "TIM")) id3tag.appendf("Time: {}", value);
    if (!strcmp(tag, "TKE")) id3tag.appendf("Initial key: {}", value);
    if (!strcmp(tag, "TLA")) id3tag.appendf("Language(s): {}", value);
    if (!strcmp(tag, "TLE")) id3tag.appendf("Length: {}", value);
    if (!strcmp(tag, "TMT")) id3tag.appendf("Media type: {}", value);
    if (!strcmp(tag, "TOA")) id3tag.appendf("Original artist(s)/performer(s): {}", value);
    if (!strcmp(tag, "TOF")) id3tag.appendf("Original filename: {}", value);
    if (!strcmp(tag, "TOL")) id3tag.appendf("Original Lyricist(s)/text writer(s): {}", value);
    if (!strcmp(tag, "TOR")) id3tag.appendf("Original release year: {}", value);
    if (!strcmp(tag, "TOT")) id3tag.appendf("Original album/Movie/Show title: {}", value);
    if (!strcmp(tag, "TP1")) id3tag.appendf("Lead artist(s)/Lead performer(s)/Soloist(s)/Performing group: {}", value);
    if (!strcmp(tag, "TP2")) id3tag.appendf("Band/Orchestra/Accompaniment: {}", value);
    if (!strcmp(tag, "TP3")) id3tag.appendf("Conductor/Performer refinement: {}", value);
    if (!strcmp(tag, "TP4")) id3tag.appendf("Interpreted, remixed, or otherwise modified by: {}", value);
    if (!strcmp(tag, "TPA")) id3tag.appendf("Part of a set: {}", value);
    if (!strcmp(tag, "TPB")) id3tag.appendf("Publisher: {}", value);
    if (!strcmp(tag, "TRC")) id3tag.appendf("ISRC (International Standard Recording Code): {}", value);
    if (!strcmp(tag, "TRD")) id3tag.appendf("Recording dates: {}", value);
    if (!strcmp(tag, "TRK")) id3tag.appendf("Track number/Position in set: {}", value);
    if (!strcmp(tag, "TSI")) id3tag.appendf("Size: {}", value);
    if (!strcmp(tag, "TSS")) id3tag.appendf("Software/hardware and settings used for encoding: {}", value);
    if (!strcmp(tag, "TT1")) id3tag.appendf("Content group description: {}", value);
    if (!strcmp(tag, "TT2")) id3tag.appendf("Title/Songname/Content description: {}", value);
    if (!strcmp(tag, "TT3")) id3tag.appendf("Subtitle/Description refinement: {}", value);
    if (!strcmp(tag, "TXT")) id3tag.appendf("Lyricist/text writer: {}", value);
    if (!strcmp(tag, "TXX")) id3tag.appendf("User defined text information frame: {}", value);
    if (!strcmp(tag, "TYE")) id3tag.appendf("Year: {}", value);
    if (!strcmp(tag, "UFI")) id3tag.appendf("Unique file identifier: {}", value);
    if (!strcmp(tag, "ULT")) id3tag.appendf("Unsychronized lyric/text transcription: {}", value);
    if (!strcmp(tag, "WAF")) id3tag.appendf("Official audio file webpage: {}", value);
    if (!strcmp(tag, "WAR")) id3tag.appendf("Official artist/performer webpage: {}", value);
    if (!strcmp(tag, "WAS")) id3tag.appendf("Official audio source webpage: {}", value);
    if (!strcmp(tag, "WCM")) id3tag.appendf("Commercial information: {}", value);
    if (!strcmp(tag, "WCP")) id3tag.appendf("Copyright/Legal information: {}", value);
    if (!strcmp(tag, "WPB")) id3tag.appendf("Publishers official webpage: {}", value);
    if (!strcmp(tag, "WXX")) id3tag.appendf("User defined URL link frame: {}", value);

    // V2.3 V2.4 tags
    if (!strcmp(tag, "COMM")) id3tag.appendf("Comment: {}", value);
    if (!strcmp(tag, "OWNE")) id3tag.appendf("Ownership: {}", value);
    if (!strcmp(tag, "PRIV")) id3tag.appendf("Private: {}", value);
    if (!strcmp(tag, "SYLT")) id3tag.appendf("SynLyrics: {}", value);
    if (!strcmp(tag, "TALB")) id3tag.appendf("Album: {}", value);
    if (!strcmp(tag, "TBPM")) id3tag.appendf("BeatsPerMinute: {}", value);
    if (!strcmp(tag, "TCAT")) id3tag.appendf("PodcastCategory: {}", value);
    if (!strcmp(tag, "TCMP")) id3tag.appendf("Compilation: {}", value);
    if (!strcmp(tag, "TCOM")) id3tag.appendf("Composer: {}", value);
    if (!strcmp(tag, "TCON")) id3tag.appendf("ContentType: {}", value);
    if (!strcmp(tag, "TCOP")) id3tag.appendf("Copyright: {}", value);
    if (!strcmp(tag, "TDAT")) id3tag.appendf("Date: {}", value);
    if (!strcmp(tag, "TDES")) id3tag.appendf("PodcastDescription: {}", value);
    if (!strcmp(tag, "TDOR")) id3tag.appendf("Original Release Year: {}", value);
    if (!strcmp(tag, "TDRC")) id3tag.appendf("Publication date: {}", value);
    if (!strcmp(tag, "TDRL")) id3tag.appendf("ReleaseTime: {}", value);
    if (!strcmp(tag, "TENC")) id3tag.appendf("Encoded by: {}", value);
    if (!strcmp(tag, "TEXT")) {} // id3tag.appendf("Lyricist: {}", value);
    if (!strcmp(tag, "TGID")) id3tag.appendf("PodcastID: {}", value);
    if (!strcmp(tag, "TIME")) id3tag.appendf("Time: {}", value);
    if (!strcmp(tag, "TIT1")) id3tag.appendf("Grouping: {}", value);
    if (!strcmp(tag, "TIT2")) id3tag.appendf("Title: {}", value);
    if (!strcmp(tag, "TIT3")) id3tag.appendf("Subtitle: {}", value);
    if (!strcmp(tag, "TLAN")) id3tag.appendf("Language: {}", value);
    if (!strcmp(tag, "TLEN")) id3tag.appendf("Length (ms): {}", value);
    if (!strcmp(tag, "TMED")) id3tag.appendf("Media: {}", value);
    if (!strcmp(tag, "TOAL")) id3tag.appendf("OriginalAlbum: {}", value);
    if (!strcmp(tag, "TOPE")) id3tag.appendf("OriginalArtist: {}", value);
    if (!strcmp(tag, "TOLY")) id3tag.appendf("OriginalLyricist: {}", value);
    if (!strcmp(tag, "TORY")) id3tag.appendf("OriginalReleaseYear: {}", value);
    if (!strcmp(tag, "TPE1")) id3tag.appendf("Artist: {}", value);
    if (!strcmp(tag, "TPE2")) id3tag.appendf("Band: {}", value);
    if (!strcmp(tag, "TPE3")) id3tag.appendf("Conductor: {}", value);
    if (!strcmp(tag, "TPE4")) id3tag.appendf("InterpretedBy: {}", value);
    if (!strcmp(tag, "TPOS")) id3tag.appendf("PartOfSet: {}", value);
    if (!strcmp(tag, "TPUB")) id3tag.appendf("Publisher: {}", value);
    if (!strcmp(tag, "TRCK")) id3tag.appendf("Track: {}", value);
    if (!strcmp(tag, "TRSN")) id3tag.appendf("InternetRadioStationName: {}", value);
    if (!strcmp(tag, "TSSE")) id3tag.appendf("SettingsForEncoding: {}", value);
    if (!strcmp(tag, "TRDA")) id3tag.appendf("RecordingDates: {}", value);
    if (!strcmp(tag, "TSO2")) id3tag.appendf("AlbumArtistSortOrder: {}", value);
    if (!strcmp(tag, "TSOA")) id3tag.appendf("AlbumSortOrder: {}", value);
    if (!strcmp(tag, "TSOP")) id3tag.appendf("PerformerSortOrder: {}", value);
    if (!strcmp(tag, "TSOC")) id3tag.appendf("ComposerSortOrder: {}", value);
    if (!strcmp(tag, "TSOT")) id3tag.appendf("TitleSortOrder: {}", value);
    if (!strcmp(tag, "TXXX")) id3tag.appendf("UserDefinedText: {}", value);
    if (!strcmp(tag, "TYER")) id3tag.appendf("Year: {}", value);
    if (!strcmp(tag, "USER")) id3tag.appendf("TermsOfUse: {}", value);
    if (!strcmp(tag, "USLT")) id3tag.appendf("Lyrics: {}", value);
    if (!strcmp(tag, "WCOM")) id3tag.appendf("Commercial URL: {}", value);
    if (!strcmp(tag, "WFED")) id3tag.appendf("Podcast URL: {}", value);
    if (!strcmp(tag, "WOAF")) id3tag.appendf("File URL: {}", value);
    if (!strcmp(tag, "WOAR")) id3tag.appendf("OfficialArtistWebpage: {}", value);
    if (!strcmp(tag, "WOAS")) id3tag.appendf("Source URL: {}", value);
    if (!strcmp(tag, "WORS")) id3tag.appendf("InternetRadioStationURL: {}", value);
    if (!strcmp(tag, "WXXX")) id3tag.appendf("User defined URL link frame: {}", value);
    if (!strcmp(tag, "XDOR")) id3tag.appendf("OriginalReleaseTime: {}", value);
