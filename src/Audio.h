...
class Audio {
  ...
  private:
    ...
    uint32_t                  calculate_average_bitrate(uint64_t sum_bytes_in, uint64_t sum_samples);
    void                      calculateAudioTime(uint16_t bytes_decoder_in, uint16_t samples_decoder_out);
